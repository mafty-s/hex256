...
export const App = () => {
    ...
    const initAbliities = () => {
        ...
        initAbility('activate_fire', 'Activate','SelectTarget',1, 2, 0, true,'damage','once_per_turn','is_not_empty|ai_is_enemy','','','');
        initAbility('activate_forest', 'Activate','SelectTarget',2, 2, 0, true,'heal','once_per_turn','is_not_empty|ai_is_ally','','','');
        initAbility('activate_select_discard_spell', 'Activate','CardSelector',0, 2, 0, false,'send_hand','has_discard_spell','is_in_discard|is_spell|is_ally','','','');
        ...
        initAbility('play_select_discard', 'OnPlay','CardSelector',0, 0, 0, false,'send_hand','has_discard_character','is_in_discard|is_character|is_ally','','','');
