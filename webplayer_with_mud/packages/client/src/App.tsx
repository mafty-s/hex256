...
export const App = () => {
    ...
    let init = () => {
        ...
        createDeck('level1_player', '', 'ashes_snake|ashes_snake|ashes_snake|ashes_snake|ashes_snake');
    ...
    const initAbliities = () => {
        ...
        initAbility('roll_attack_bonus', 'None','Self',6, 0, 1, false,'','rolled_4P','','');
        ...
        initAbility('turn_stealth', 'EndOfTurn','Self',0, 0, 0, false,'clear_taunt','has_board_characters2','','');
        ...
        initAbility('trap_paralyse3', 'OnAfterAttack','AbilityTriggerer',0, 0, 6, false,'','is_character|is_enemy','','');
