...
export const App = () => {
    ...
    let init = () => {
        ...
        createDeck('level1_player', '', 'wolf_alpha|wolf_baby|spell_roots|wolf_baby|spell_roots');
        createDeck('level2_ai', '', 'imp|imp|spell_stones|fire_chicken|fire_chicken|spell_burn');
        createDeck('level2_player', '', 'tree_angry|snake_venom|potion_green|raccoon|potion_green|potion_green');
    ...
    const initAbliities = () => {
        ...
        initAbility('activate_discard', 'Activate', 'AllCardsHand', 1, 0, 0, true, 'discard');
        initAbility('activate_fire', 'Activate', 'SelectTarget', 1, 2, 0, true, 'damage');
        initAbility('activate_forest', 'Activate', 'SelectTarget', 2, 2, 0, true, 'heal');
        initAbility('activate_select_discard_spell', 'Activate', 'CardSelector', 0, 2, 0, false, 'send_hand');
        initAbility('activate_send_hand', 'Activate', 'SelectTarget', 0, 0, 0, true, 'send_hand');
        initAbility('activate_water', 'Activate', 'PlayerSelf', 1, 3, 0, true, 'draw');
        initAbility('chain_gain_attack', 'None', 'Self', 1, 0, 0, false, 'add_attack');
        initAbility('activate_roll_send_hand', 'Activate', 'SelectTarget', 0, 2, 0, false, 'roll_d6');
        initAbility('attack_roll_attack_bonus', 'OnBeforeAttack', 'Self', 0, 0, 0, false, 'roll_d6');
        initAbility('play_roll_attack', 'OnPlay', 'Self', 0, 0, 0, false, 'roll_d6');
        initAbility('roll_add_attack', 'None', 'Self', 0, 0, 0, false, 'add_attack_roll');
        initAbility('roll_attack_bonus', 'None', 'Self', 6, 0, 1, false, '');
        initAbility('roll_send_hand', 'None', 'LastTargeted', 0, 0, 0, false, 'send_hand');
        initAbility('chain_equip_use', 'None', 'Self', -1, 0, 0, false, 'add_hp');
        initAbility('equip_armor2', 'Ongoing', 'EquippedCard', 2, 0, 0, false, '');
        ...
        initAbility('equip_attack_no_damage', 'OnBeforeAttack', 'EquippedCard', 0, 0, 1, false, '');
        ...
        initAbility('equip_gain_mana', 'StartOfTurn', 'PlayerSelf', 2, 0, 0, false, 'gain_mana');
        initAbility('equip_mana_kill', 'OnKill', 'PlayerSelf', 3, 0, 0, false, 'gain_mana');
        initAbility('equip_taunt', 'Ongoing', 'EquippedCard', 0, 0, 0, false, '');
        ...
        initAbility('deathtouch', 'Ongoing', 'Self', 0, 0, 0, false, '');
        initAbility('defense_attack3', 'Ongoing', 'Self', 3, 0, 0, false, 'add_attack');
        initAbility('flying', 'Ongoing', 'Self', 0, 0, 0, false, '');
        initAbility('fury', 'Ongoing', 'Self', 0, 0, 0, false, '');
        initAbility('lifesteal', 'Ongoing', 'Self', 0, 0, 0, false, '');
        initAbility('spell_immunity', 'Ongoing', 'Self', 0, 0, 0, false, '');
        initAbility('taunt', 'Ongoing', 'Self', 0, 0, 0, false, '');
        ...
        initAbility('trample', 'Ongoing', 'Self', 0, 0, 0, false, '');
        initAbility('after_spell_attack2', 'OnPlayOther', 'Self', 2, 0, 0, false, 'add_attack');
        initAbility('attack_player_mana2', 'OnAfterAttack', 'PlayerSelf', 2, 0, 0, false, 'gain_mana');
        initAbility('attack_poison', 'OnBeforeAttack', 'AbilityTriggerer', 1, 0, 0, false, '');
        ...
        initAbility('death_blue_draw', 'OnDeathOther', 'PlayerSelf', 1, 0, 0, false, 'draw');
        initAbility('death_egg', 'OnDeath', 'Self', 2, 0, 0, false, 'summon_egg');
        initAbility('death_heal2', 'OnDeath', 'PlayerSelf', 2, 0, 0, false, 'heal');
        initAbility('death_other_draw', 'OnDeathOther', 'PlayerSelf', 1, 0, 0, false, 'draw');
        initAbility('defend_discard', 'OnBeforeDefend', 'AllCardsHand', 1, 0, 0, false, 'discard');
        initAbility('defend_poison', 'OnBeforeDefend', 'AbilityTriggerer', 1, 0, 0, false, '');
        initAbility('egg_growth', 'StartOfTurn', 'Self', 1, 0, 0, false, 'add_growth');
        initAbility('egg_transform', 'StartOfTurn', 'Self', 0, 0, 0, false, 'transform_phoenix');
        initAbility('kill_draw2', 'OnKill', 'PlayerSelf', 2, 0, 0, false, 'draw');
        initAbility('play_other_sacrifice', 'OnPlayOther', 'Self', 0, 0, 0, false, 'destroy');
        ...
        initAbility('turn_kill_lowest', 'StartOfTurn', 'AllCardsBoard', 0, 0, 0, false, 'destroy');
        initAbility('turn_stealth', 'EndOfTurn', 'Self', 0, 0, 0, false, 'clear_taunt');
        initAbility('choice_fury', 'None', 'Self', 0, 0, 0, false, '');
        initAbility('choice_taunt', 'None', 'Self', 0, 0, 0, false, '');
        initAbility('play_boost2', 'OnPlay', 'SelectTarget', 2, 0, 2, true, '');
        initAbility('play_choice_taunt_fury', 'OnPlay', 'ChoiceSelector', 0, 0, 0, false, '');
        ...
        initAbility('play_destroy_less4', 'OnPlay', 'SelectTarget', 0, 0, 0, false, 'destroy');
        initAbility('play_discard', 'OnPlay', 'AllCardsAllPiles', 1, 0, 0, false, 'discard');
        initAbility('play_haste', 'OnPlay', 'Self', 0, 0, 0, false, 'unexhaust');
        initAbility('play_poison', 'OnPlay', 'SelectTarget', 1, 0, 0, false, '');
        initAbility('play_select_discard', 'OnPlay', 'CardSelector', 0, 0, 0, false, 'send_hand');
        initAbility('play_set_attack1', 'OnPlay', 'SelectTarget', 1, 0, 0, false, 'set_attack');
        initAbility('play_silence', 'OnPlay', 'SelectTarget', 0, 0, 0, false, 'clear_status_all|reset_stats');
        initAbility('play_summon_wolf', 'OnPlay', 'AllSlots', 1, 0, 0, false, 'summon_wolf');
        initAbility('shell', 'OnPlay', 'Self', 0, 0, 0, false, '');
        initAbility('stealth', 'OnPlay', 'Self', 0, 0, 0, false, '');
        ...
        initAbility('chain_hibernate', 'None', 'PlayTarget', 0, 0, 4, false, 'exhaust');
        initAbility('chain_treasure', 'None', 'CardSelector', 0, 0, 0, false, 'send_hand');
        ...
        initAbility('spell_armor2', 'OnPlay', 'PlayTarget', 2, 0, 0, false, '');
        ...
        initAbility('spell_dragon_create', 'OnPlay', 'AllCardData', 0, 0, 0, false, 'create_temp');
        initAbility('spell_draw1', 'OnPlay', 'PlayerSelf', 1, 0, 0, false, 'draw');
        initAbility('spell_fury', 'OnPlay', 'PlayTarget', 0, 0, 0, false, '');
        initAbility('spell_heal_full', 'OnPlay', 'PlayTarget', 99, 0, 0, false, 'heal');
        initAbility('spell_hibernate', 'OnPlay', 'PlayTarget', 4, 0, 0, false, 'add_attack|add_hp');
        initAbility('spell_hp2', 'OnPlay', 'PlayTarget', 2, 0, 0, false, 'add_hp');
        initAbility('spell_kill_lowest_hp', 'OnPlay', 'AllCardsBoard', 0, 0, 0, false, 'destroy');
        initAbility('spell_paralyse', 'OnPlay', 'PlayTarget', 0, 0, 6, false, '');
        ...
        initAbility('spell_shell', 'OnPlay', 'PlayTarget', 0, 0, 0, false, '');
        initAbility('spell_summon_eagle', 'OnPlay', 'PlayerSelf', 0, 0, 0, false, 'summon_eagle|summon_eagle|summon_eagle');
        initAbility('spell_taunt', 'OnPlay', 'PlayTarget', 0, 0, 0, false, '');
        initAbility('spell_treasure', 'OnPlay', 'CardSelector', 0, 0, 0, false, 'send_hand');
