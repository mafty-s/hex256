...
FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x005b0a0514010101010101012020000000000000000000000000000000000000
);
...
library Players {
  ...
  function getValueSchema() internal pure returns (Schema) {
    ...
    _valueSchema[14] = SchemaType.UINT16_ARRAY;
  ...
  function setTrait(bytes32 key, uint16[] memory trait) internal {
    ...
    StoreSwitch.setDynamicField(_tableId, _keyTuple, 4, EncodeArray.encode((trait)));
  }
  ...
  function _setTrait(bytes32 key, uint16[] memory trait) internal {
    ...
    StoreCore.setDynamicField(_tableId, _keyTuple, 4, EncodeArray.encode((trait)));
  }
  ...
  function set(
    ...
    PackedCounter _encodedLengths = encodeLengths(name, deck, status, ongoingStatus, trait);
    bytes memory _dynamicData = encodeDynamic(name, deck, status, ongoingStatus, trait);
  ...
  function decode(
    ...
    (_table.name, _table.deck, _table.status, _table.ongoingStatus, _table.trait) = decodeDynamic(
      _encodedLengths,
      _dynamicData
    );
  }
