...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("MatchesExtended")))
);
ResourceId constant MatchesExtendedTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0081050001202020200000000000000000000000000000000000000000000000
);

struct MatchesExtendedData {
...
library MatchesExtended {
   ...
   */
  function get(bytes32 key) internal view returns (MatchesExtendedData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 key) internal view returns (MatchesExtendedData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function set(bytes32 key, MatchesExtendedData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 key, MatchesExtendedData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.selector,
      _table.selectorPlayerId,
      _table.lastPlayed,
  ...
  function decode(
    ...
    PackedCounter,
    bytes memory
  ) internal pure returns (MatchesExtendedData memory _table) {
    (
      _table.selector,
      _table.selectorPlayerId,
      _table.lastPlayed,
