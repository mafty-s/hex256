...
// Import user types
import { GameType, GameState, GamePhase } from "./../common.sol";

ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("Games")))
);
...
library Games {
  ...
  /**
   * @notice Get gamePhase.
   */
  function getGamePhase(bytes32 key) internal view returns (GamePhase gamePhase) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    bytes32 _blob = StoreSwitch.getStaticField(_tableId, _keyTuple, 2, _fieldLayout);
    return GamePhase(uint8(bytes1(_blob)));
  }

  /**
   * @notice Get gamePhase.
   */
  function _getGamePhase(bytes32 key) internal view returns (GamePhase gamePhase) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Set gamePhase.
   */
  function setGamePhase(bytes32 key, GamePhase gamePhase) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked(uint8(gamePhase)), _fieldLayout);
  }

  /**
   * @notice Set gamePhase.
   */
  function _setGamePhase(bytes32 key, GamePhase gamePhase) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreCore.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked(uint8(gamePhase)), _fieldLayout);
  }
  ...
  function setFirstPlayer(bytes32 key, bytes32 firstPlayer) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((firstPlayer)), _fieldLayout);
  }
  ...
  function _setFirstPlayer(bytes32 key, bytes32 firstPlayer) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((firstPlayer)), _fieldLayout);
  }
  ...
  function setCurrentPlayer(bytes32 key, bytes32 currentPlayer) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((currentPlayer)), _fieldLayout);
  }
  ...
  function _setCurrentPlayer(bytes32 key, bytes32 currentPlayer) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((currentPlayer)), _fieldLayout);
  }

  /**
   * @notice Get turnCount.
   */
   ...
   * @notice Get turnCount.
   */
  function _getTurnCount(bytes32 key) internal view returns (uint8 turnCount) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Set turnCount.
   */
  function setTurnCount(bytes32 key, uint8 turnCount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((turnCount)), _fieldLayout);
  }

  /**
   * @notice Set turnCount.
   */
  function _setTurnCount(bytes32 key, uint8 turnCount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreCore.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((turnCount)), _fieldLayout);
  }
   ...
   * @notice Get nbPlayer.
   */
  function _getNbPlayer(bytes32 key) internal view returns (uint8 nbPlayer) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set nbPlayer.
   */
  function setNbPlayer(bytes32 key, uint8 nbPlayer) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set nbPlayer.
   */
  function _setNbPlayer(bytes32 key, uint8 nbPlayer) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get level.
   */
  function getLevel(bytes32 key) internal view returns (string memory level) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get level.
   */
  function _getLevel(bytes32 key) internal view returns (string memory level) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set level.
   */
  function setLevel(bytes32 key, string memory level) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreSwitch.setDynamicField(_tableId, _keyTuple, 0, bytes((level)));
  }

  /**
   * @notice Set level.
   */
  function _setLevel(bytes32 key, string memory level) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreCore.setDynamicField(_tableId, _keyTuple, 0, bytes((level)));
  }

  /**
   * @notice Get the length of level.
   */
  function lengthLevel(bytes32 key) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the length of level.
   */
  function _lengthLevel(bytes32 key) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Get an item of level.
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemLevel(bytes32 key, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemLevel(bytes32 key, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Push a slice to level.
   */
  function pushLevel(bytes32 key, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Push a slice to level.
   */
  function _pushLevel(bytes32 key, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Pop a slice from level.
   */
  function popLevel(bytes32 key) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Pop a slice from level.
   */
  function _popLevel(bytes32 key) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Update a slice of level at `_index`.
   */
  function updateLevel(bytes32 key, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Update a slice of level at `_index`.
   */
  function _updateLevel(bytes32 key, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function setUid(bytes32 key, string memory uid) internal {
    ...
    StoreSwitch.setDynamicField(_tableId, _keyTuple, 1, bytes((uid)));
  }
  ...
  function _setUid(bytes32 key, string memory uid) internal {
    ...
    StoreCore.setDynamicField(_tableId, _keyTuple, 1, bytes((uid)));
  }
  ...
  function setPlayers(bytes32 key, bytes32[] memory players) internal {
    ...
    StoreSwitch.setDynamicField(_tableId, _keyTuple, 2, EncodeArray.encode((players)));
  }
  ...
  function _setPlayers(bytes32 key, bytes32[] memory players) internal {
    ...
    StoreCore.setDynamicField(_tableId, _keyTuple, 2, EncodeArray.encode((players)));
  }
   ...
   */
  function get(bytes32 key) internal view returns (GamesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 key) internal view returns (GamesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function set(
    ...
    PackedCounter _encodedLengths = encodeLengths(level, uid, players);
    bytes memory _dynamicData = encodeDynamic(level, uid, players);
   ...
   */
  function set(bytes32 key, GamesData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.gameType,
      _table.gameState,
      _table.gamePhase,
    ...
    PackedCounter _encodedLengths = encodeLengths(_table.level, _table.uid, _table.players);
    bytes memory _dynamicData = encodeDynamic(_table.level, _table.uid, _table.players);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 key, GamesData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.gameType,
      _table.gameState,
      _table.gamePhase,
    ...
    )
  {
    ...
    gamePhase = GamePhase(uint8(Bytes.slice1(_blob, 2)));

    firstPlayer = (Bytes.slice32(_blob, 3));

    currentPlayer = (Bytes.slice32(_blob, 35));
  ...
  function decodeDynamic(
    ...
    bytes memory _blob
  ) internal pure returns (string memory level, string memory uid, bytes32[] memory players) {
    uint256 _start;
    uint256 _end;
    unchecked {
      _end = _encodedLengths.atIndex(0);
    }
    level = (string(SliceLib.getSubslice(_blob, _start, _end).toBytes()));
  ...
  function decode(
  ...
  ) internal pure returns (GamesData memory _table) {
    (
      _table.gameType,
      _table.gameState,
      _table.gamePhase,
    ...
    (_table.level, _table.uid, _table.players) = decodeDynamic(_encodedLengths, _dynamicData);
  }
  ...
  function encodeLengths(
    ...
    unchecked {
      _encodedLengths = PackedCounterLib.pack(bytes(level).length, bytes(uid).length, players.length * 32);
    }
  }
  ...
  function encodeDynamic(
    ...
    return abi.encodePacked(bytes((level)), bytes((uid)), EncodeArray.encode((players)));
  }
