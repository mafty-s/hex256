...
contract Effect3System is System {
    ...
    function EffectAddAbilityActivateBurst(bytes32 game_uid,bytes32 ability_key, bytes32 caster, bytes32 target, ConditionTargetType is_card) public {
    ...
    function EffectAddAbilityDefendDiscard(bytes32 game_uid,bytes32 ability_key, bytes32 caster, bytes32 target, ConditionTargetType is_card) public {
    ...
    function EffectAddAbilityPlaySacrifice(bytes32 game_uid,bytes32 ability_key, bytes32 caster, bytes32 target, ConditionTargetType is_card) public {
    ...
    function EffectAddAbilitySufferDamage(bytes32 game_uid,bytes32 ability_key, bytes32 caster, bytes32 target, ConditionTargetType is_card) public {
